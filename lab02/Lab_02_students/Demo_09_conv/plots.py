...
plt.savefig('out/plot_random_matrix_and_kernel.jpg', bbox_inches='tight')
...
plt.savefig('out/plot_random_feature_map.jpg', bbox_inches='tight')
...
for j_i, j in enumerate([0, 2, 4]):
    ...
    # Highlighted matrix
        ...
        plt.savefig( 'out/plot_convolution_process_{}_{}.jpg'.format(j,i), bbox_inches='tight')
